 ...
 * Enhanced with Manila timezone support and rank-and-file business logic
 * 
 * @author User
 */
public class EmployeeDAO extends BaseDAO<EmployeeModel, Integer> {
    ...
    // METHODS REQUIRED BY OTHER CLASSES (to fix compilation errors)
    ...
    // CUSTOM EMPLOYEE METHODS - Enhanced with business logic
    ...
    public List<EmployeeModel> getEmployeesByRole(String userRole) {
        String sql = "SELECT * FROM employee WHERE userRole = ? ORDER BY lastName, firstName";
